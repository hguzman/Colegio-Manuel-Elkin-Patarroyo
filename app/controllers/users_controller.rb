class UsersController < ApplicationController
  ...
  before_action :set_user, only: [:show, :edit, :update, :destroy]
    ...
    def user_params
      params.require(:user).permit(:identifiacion,:email,:password,:password_confirmation,:nombres,:apellidos,:segundo_nombre,:segundo_apellido,:direccion,:telefono,:avatar,role_ids:  [])
    end
end
